// Store a list of ten students in a mutable list. Each student entry should have a name, roll number, and percentage marks. Make functions inside the class Student to print the values of each student in a separate line and then make Student class as data class and directly print the values.
